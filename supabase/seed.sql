...
values
  ...
  ('gesture-eat-food', 'gesture', 'I want to eat', 'cat-gestures', 'Fixed demo gesture for saying that the learner wants to eat.', 'Keep the learner centered and check that the live hand outline follows the movement.', null, null, null, array['gesture', 'fixed', 'demo'], null, (select id from public.profiles where email = 'admin@makalearn.local')),
  ('gesture-drink-water', 'gesture', 'I want to drink', 'cat-gestures', 'Fixed demo gesture for requesting a drink.', 'Use the hand visibility indicator before giving corrective feedback.', null, null, null, array['gesture', 'fixed', 'demo'], null, (select id from public.profiles where email = 'admin@makalearn.local')),
